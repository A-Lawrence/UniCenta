...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    public final String findVersion(boolean openBravoCheck) throws BasicException {
        if(openBravoCheck){
            String tmp = (String) m_version.find("openbravopos");
            if(tmp == null){
                return (String) findVersion(false);
            } else {
                return (String) tmp;
            }
        } else {
